    ...
    def checkstatus(self,status):
        try:
            ...
            if statusstring.split("=")[1]==status:
                ...
                print "Status update failed!! Correct status should be ",status
                print "Status in property file is :",statusstring.split("=")[1]
                sys.exit(1)
        except Exception as e:
...
def Usage():
    ...
    print '--checkstatus: Check esg status in esgstatus.properties\n'
    ...
    print "python updateStatus.py  --esgip 10.226.38.7 --statusFpath  X:\\legacyautomation  --status ready --checkstatus\n"
